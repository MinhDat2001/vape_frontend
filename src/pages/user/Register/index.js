            ...
            <div className="auth-form">
                ...
                <div className="form">
                    <div className="contain">
                        ...
                        <input id="username" className='input' type="email" placeholder="Nhập email của bạn"/>
                    </div>
                    <div className="contain">
                        <label className='label'>Họ Tên *</label>
                        <input id="name" className='input' type="text" placeholder="Nhập họ tên"/>
                    </div>
                    <div className="contain">
                        <label className='label'>Điện thoại *</label>
                        <input id="phone" className='input' type="text" placeholder="Nhập số điện thoại"/>
                    </div>
                    <div className="contain">
                    ...
                    <div className="contain">
                        ...
                        <input id="house" className='input' type="text" placeholder="Đường, số nhà"/>
                    </div>
                    <div className="contain">
                        <label className='label'>Mật khẩu *</label>
                        <input id="password" className='input' type="password" placeholder="Mật khẩu"/>
                    </div>
                    <div className="contain">
                        <label className='label'>Nhập lại mật khẩu *</label>
                        <input id="re-password" className='input' type="password" placeholder="Nhập lại mật khẩu"/>
                    </div>
                    <div className="contain">
                        <label id="warnning" className='warnning'></label>
                    </div>
                    <div className="contain">
                        <button id='login-btn' onClick={register} className='primary-btn button'>Đăng ký</button>
                    </div>
                </div>
            </div>
        </div>
...
function validate(){
    ...
    if(email.value==="" ||name.value==="" ||phone.value==="" ||password.value==="" ||re_password.value===""){
        document.getElementById("warnning").innerHTML="Các trường * không được để trống!";
        return;
    }
    ...
    if (!/(84|0[3|5|7|8|9])+([0-9]{8})\b/.test(phone.value)){
        document.getElementById("warnning").innerHTML="Nhập đúng định dạng số điện thoại!";
        return;
    }
